      ...
      <section class="hero">
        <div class="hero-grid">
          ...
          <div>
            ...
            <p>Benchmark and demo layer for explainable identity resolution. Headline metrics come only from the curated real-profile benchmark; stress suites are reported separately.</p>
          </div>
        </div>
      </section>
